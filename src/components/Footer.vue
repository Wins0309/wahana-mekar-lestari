<template>
  <footer class="bg-[#4C3930] text-[#F1E8DF] py-12 lg:py-20">
    <div class="container mx-auto px-4 lg:px-0">
        ...
        <div class="lg:col-span-5">
          ...
          <div class="space-y-4 text-sm lg:text-base">
            <p class="leading-relaxed">
              Gedung Wirausaha, Jl. Haji R. Rasuna Said<br>
              Kavling C5, RT.3/RW.1, Karet Kuningan,<br>
      ...
      <!-- Copyright Section -->
      <div class="flex flex-col lg:flex-row justify-between items-center mt-8 lg:mt-12 gap-4">
        <p class="text-[#F1E8DF] text-center lg:text-start">
          © 2025 PT. Wahana Mekar Lestari. All Rights Reserved.
        </p>
        <div class="flex space-x-4 lg:space-x-6">
          <!-- LinkedIn -->
          <a
            href="#"
            class="w-8 h-8 lg:w-10 lg:h-10 flex items-center justify-center text-[#F1E8DF] hover:text-[#F1E8DF] transition-colors"
            aria-label="LinkedIn"
          >
